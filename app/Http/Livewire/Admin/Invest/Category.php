...
class Category extends Component
{
    ...
    public function addCategory()
    {
        ...
        if (Topic::whereType('invest')->whereName($this->cat_name)->count() > 0) {
    ...
    {
        $this->category = Topic::whereType('invest')->when($this->search, function ($query) {
            $this->emit('drawer');
        ...
        return view('livewire.admin.invest.category', ['category' => $this->category]);
    }
}
