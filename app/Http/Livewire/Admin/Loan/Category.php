...
class Category extends Component
{
    ...
    public function addCategory()
    {
        ...
        if (Topic::whereType('product')->whereName($this->cat_name)->count() > 0) {
    ...
    {
        $this->category = Topic::whereType('product')->when($this->search, function ($query) {
            $this->emit('drawer');
        ...
        return view('livewire.admin.loan.category', ['category' => $this->category]);
    }
}
