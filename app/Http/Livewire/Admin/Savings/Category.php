...
class Category extends Component
{
    ...
    {
        $this->category = Topic::whereType('circle_category')->when($this->search, function ($query) {
            $this->emit('drawer');
        ...
        return view('livewire.admin.savings.category', ['category' => $this->category]);
    }
}
