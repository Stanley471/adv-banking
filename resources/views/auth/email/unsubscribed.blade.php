        ...
        <div class="d-flex flex-column flex-lg-row-fluid">
            <div class="d-flex flex-center flex-column flex-column-fluid">
                <div class="w-lg-700px w-700px">
                    ...
                    <div class="fs-3 fw-bold text-white mb-10">{{__('You have successfully unsubscribed from receiving promotional emails.')}}</div>
                    <div class="mb-10">
                        <a href="{{route('home')}}" class="btn btn-outline btn-lg btn-outline-secondary btn-active-secondary">{{__('Home')}}</a>
                    </div>
                </div>
            </div>
        </div>
