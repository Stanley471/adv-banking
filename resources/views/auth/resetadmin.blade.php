      ...
      <div class="card-body m-5">
        <form class="form w-100" action="{{route('admin.check')}}" method="post">
          ...
          <div class="text-start mb-10">
            <h1 class="text-dark mb-3 fs-2">{{__('Reset password')}}</h1>
          </div>
          <div class="fv-row mb-10">
            ...
            <div class="position-relative">
              <input class="form-control form-control-lg form-control-solid border-light" type="password" name="password" autocomplete="off" required data-toggle="password" id="password" placeholder="XXXXXX" required />
