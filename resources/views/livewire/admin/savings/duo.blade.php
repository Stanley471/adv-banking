                        ...
                        <div class="card-body p-9">
                            ...
                            <div class="fs-6 d-flex justify-content-between mb-4">
                                ...
                                <div class="d-flex fw-boldest">
                                    {{number_format_short($admin->savings('active', 'duo')->sum('amount')).' '.$currency->currency}} [{{$admin->savings('active', 'duo')->count()}}]
                                </div>
                            </div>
                            ...
                            <div class="fs-6 d-flex justify-content-between my-4">
                                ...
                                <div class="d-flex fw-boldest">
                                    {{number_format_short($admin->totalSavingsReturn('duo', 'paid')->sum('amount')).' '.$currency->currency}}
                                </div>
                            </div>
                                                ...
                                                <div class="d-flex flex-stack mb-6 bg-light p-3 rounded-3">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="ps-2">
                                                            ...
                                                            <p class="fs-6 text-dark mb-0">{{$val->user->business->name}} X {{$val->partner->business->name}}</p>
                            ...
                            <form wire:submit.prevent="save" method="post">
                                ...
                                <div class="fv-row mb-6">
                                    ...
                                    <div class="input-group">
                                        <input type="number" steps="any" wire:model.defer="dsi" steps="any" class="form-control form-control-lg form-control-solid" placeholder="0.00">
                                ...
                                <div class="form-check form-check-custom form-check-solid mb-6">
                                    <input class="form-check-input" type="checkbox" id="flexCheckDefault" wire:model.defer="dgg" />
                                    <label class="form-check-label" for="flexCheckDefault">{{__('Restrict interest earning to user reaching their goals')}}</label>
                                </div>
                                <div class="form-check form-check-custom form-check-solid mb-6">
                                    <input class="form-check-input" type="checkbox" id="flexCheckDefault" wire:model.defer="dss" />
                                ...
                                <div class="text-start">
                                    <button type="submit" class="btn btn-lg btn-info fw-bolder me-3 my-2 mb-3">
                                        <span wire:loading.remove wire:target="save">{{__('Update Duo Savings')}}</span>
