    ...
    <div class="post fs-6 d-flex flex-column-fluid min-vh-100" id="kt_post">
        <div class="container">
                ...
                <div class="d-flex flex-stack">
                    <div class="d-flex align-items-center">
                        <div class="symbol symbol-40px symbol-circle" data-bs-toggle="tooltip" title="" data-bs-original-title="{{$val->user->business->name}}">
                            <div class="symbol-label" style="background-image:url({{url('/').'/storage/app/'.$val->plan->image}})"></div>
                        </div>
                        <div class="ps-3">
                            <p class="fs-6 text-dark text-hover-primary fw-bolder mb-0"><a href="{{route('admin.invest.plan', ['plan' => $val->plan->id, 'type' => 'edit'])}}">{{$val->plan->name}}</a></p>
            ...
            <div class="text-center mt-20">
                ...
                <h3 class="text-dark">{{__('No Investment Found')}}</h3>
            </div>
            @endif
        </div>
    </div>
