    ...
    <div class="card w-100">
        ...
        <div class="card-body text-wrap">
            ...
            <div class="btn-wrapper text-center mb-3">
                ...
                <p class="text-dark fs-5 fw-bold mb-6">{{__('Choose Transfer Type')}}</p>
            </div>
                        ...
                        <div class="card-body p-5">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                    <h4 class="text-dark fw-bold mb-1">{{__('Internal Transfer')}}</h4>
                                    <p class="text-muted small mb-0">{{__('Send money to other ').$set->site_name.__(' users instantly')}}</p>
                                </div>
                    ...
                    <div class="card bg-light-success cursor-pointer hover-shadow" wire:click="selectTransferType('external')" style="transition: all 0.3s;">
                        <div class="card-body p-5">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                    <h4 class="text-dark fw-bold mb-1">{{__('External Transfer')}}</h4>
                                    <p class="text-muted small mb-0">{{__('Wire/ACH transfer to any US bank account')}}</p>
                                </div>
            ...
            @elseif($transfer_type == 'internal')
            <!-- INTERNAL TRANSFER FLOW -->
            @include('partials.transfer.internal')
            
            @elseif($transfer_type == 'external')
            <!-- EXTERNAL TRANSFER FLOW -->
            @include('partials.transfer.external')
...
<div class="icon-grid">
    <a href="{{route('user.transactions')}}" class="icon-item">
        <div class="icon-box" style="width: 70px; height: 70px; background: #556B2F;">
...
<div class="icon-grid">
    ...
    <a href="{{route('blog')}}" class="icon-item">
        <div class="icon-box" style="width: 70px; height: 70px; background: #556B2F;">
