@if(!in_array($set->default_font, ['HKGroteskPro', 'Graphik']))
<style>
...
@if($set->default_font == "Graphik")
    <style>
        @font-face {
        font-family: Graphik;
        font-weight: 400;
        src: url({{asset('asset/fonts/Graphik/GraphikRegular.otf')}});
    }
    ...
    @font-face {
        font-family: Graphik;
        font-weight: 700;
        src: url({{asset('asset/fonts/Graphik/GraphikMedium.otf')}});
    }

    @font-face {
        font-family: Graphik;
        font-weight: 800;
        src: url({{asset('asset/fonts/Graphik/GraphikBold.otf')}});
    }
