    ...
    <div class="toolbar" id="kt_toolbar">
        <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                <h1 class="text-dark fw-bolder my-1 fs-2"><?php echo e(__('Transactions')); ?></h1>
                <ul class="breadcrumb fw-semibold fs-base my-1">
                    <li class="breadcrumb-item text-muted">
                        <a href="<?php echo e(route('user.dashboard')); ?>" class="text-muted text-hover-primary">Dashboard </a>
                    </li>
                    <li class="breadcrumb-item text-dark"><?php echo e(__('Transactions')); ?></li>
                </ul>
            </div>
                ...
                <div class="card-body text-wrap">
                    ...
                    <div class="fv-row mb-6">
                        ...
                        <select class="form-select form-select-solid" wire:model="type">
                            ...
                            <option value="savings_return"><?php echo e(__('Savings Return')); ?></option>
                            <option value="savings_deposit"><?php echo e(__('Savings Deposit')); ?></option>
                            <option value="dividend_return"><?php echo e(__('Dividend Return')); ?></option>
                        </select>
                    </div>
                    <div class="fv-row mb-6">
                                    ...
                                    <table class="table align-middle table-row-bordered table-row-gray-300 gy-5 gs-7" id="kt_datatable_example_5">
                                        <thead>
                                            <tr class="text-start text-dark fw-bolder fs-7 text-uppercase px-7">
                                                ...
                                                <th class="min-w-100px"><?php echo e(__('Type')); ?></th>
                                        ...
                                        <tbody class="fw-semibold text-dark fs-6">
                                            <?php echo $__env->make('partials.transfer.table', ['all' => 1], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        </tbody>
                                    </table>
...
</div><?php /**PATH C:\xampp\htdocs\adv-banking\resources\views/livewire/transactions/all.blade.php ENDPATH**/ ?>