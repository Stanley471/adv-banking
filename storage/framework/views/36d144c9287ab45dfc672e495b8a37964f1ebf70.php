        ...
        <header class="header navbar navbar-expand-lg position-absolute navbar-sticky <?php if(url()->current() == route('home')): ?> navbar-dark <?php else: ?> navbar-light <?php endif; ?>">
            <div class="container px-3">
                <a href="<?php echo e(route('home')); ?>" class="navbar-brand pe-3">
                    ...
                    <img src="<?php echo e(asset('asset/images/maccity logo.png')); ?>"  width="200" alt="<?php echo e($set->site_name); ?>" loading="lazy">
                    <?php else: ?>
                    <img src="<?php echo e(asset('asset/images/maccity logo.png')); ?>" width="200" alt="<?php echo e($set->site_name); ?>" loading="lazy">
                    <?php endif; ?>
                </a>
...
</html><?php /**PATH C:\xampp\htdocs\adv-banking\resources\views/front/menu.blade.php ENDPATH**/ ?>