...
unset($__errorArgs, $__bag); ?>
        ...
        <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('admin.payout.details', ['val' => $val,'admin' => $admin])->html();
    ...
    $response = \Livewire\Livewire::mount('admin.payout.details', ['val' => $val,'admin' => $admin]);
    $html = $response->html();
...
</div><?php /**PATH C:\xampp\htdocs\adv-banking\resources\views/livewire/admin/payout/index.blade.php ENDPATH**/ ?>