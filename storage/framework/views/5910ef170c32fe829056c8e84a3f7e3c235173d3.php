    ...
    <div class="card w-100">
        <div class="card-header pe-5 border-0">
            ...
            <div class="card-toolbar">
                <div class="btn btn-sm btn-icon btn-icon-dark btn-active-light-primary" data-kt-drawer-dismiss="true" id="kt_transfer_money_close">
        ...
        <div class="card-body text-wrap">
            ...
            <?php if(!$transfer_type_selected): ?>
            <!-- Step 0: Choose Transfer Type -->
            <div class="btn-wrapper text-center mb-3">
                <div class="symbol symbol-100px symbol-circle me-5 mb-10">
                    <div class="symbol-label fs-1 text-dark bg-light-info">
                        <i class="fal fa-exchange-alt fa-2x text-info"></i>
                    </div>
                </div>
                <p class="text-dark fs-5 fw-bold mb-6"><?php echo e(__('Choose Transfer Type')); ?></p>
            </div>
            
            <div class="row g-4">
                <!-- Internal Transfer Option -->
                <div class="col-12">
                    <div class="card bg-light-primary cursor-pointer hover-shadow" wire:click="selectTransferType('internal')" style="transition: all 0.3s;">
                        <div class="card-body p-5">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                    <h4 class="text-dark fw-bold mb-1"><?php echo e(__('Internal Transfer')); ?></h4>
                                    <p class="text-muted small mb-0"><?php echo e(__('Send money to other ').$set->site_name.__(' users instantly')); ?></p>
                                </div>
                ...
                <div class="col-12">
                    <div class="card bg-light-success cursor-pointer hover-shadow" wire:click="selectTransferType('external')" style="transition: all 0.3s;">
                        <div class="card-body p-5">
                            <div class="d-flex align-items-center">
                                <div class="symbol symbol-60px me-4">
                                ...
                                <div class="flex-grow-1">
                                    <h4 class="text-dark fw-bold mb-1"><?php echo e(__('External Transfer')); ?></h4>
                                    <p class="text-muted small mb-0"><?php echo e(__('Wire/ACH transfer to any US bank account')); ?></p>
                                </div>
            ...
            <?php elseif($transfer_type == 'internal'): ?>
            <!-- INTERNAL TRANSFER FLOW -->
            <?php echo $__env->make('partials.transfer.internal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            
            <?php elseif($transfer_type == 'external'): ?>
            <!-- EXTERNAL TRANSFER FLOW -->
            <?php echo $__env->make('partials.transfer.external', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->stopSection(); ?><?php /**PATH C:\xampp\htdocs\adv-banking\resources\views/livewire/balance.blade.php ENDPATH**/ ?>