...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('rU6Dcor')) {
    $componentId = $_instance->getRenderedChildComponentId('rU6Dcor');
    $componentTag = $_instance->getRenderedChildComponentTagName('rU6Dcor');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('rU6Dcor');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('rU6Dcor', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('user.menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/soccrquq/clovergatebank.com/resources/views/user/dashboard/index.blade.php ENDPATH**/ ?>