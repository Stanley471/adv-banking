...
} elseif ($_instance->childHasBeenRendered('7FAvKoC')) {
    $componentId = $_instance->getRenderedChildComponentId('7FAvKoC');
    $componentTag = $_instance->getRenderedChildComponentTagName('7FAvKoC');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('7FAvKoC');
} else {
    $response = \Livewire\Livewire::mount('settings.options', ['user' => $user, 'set' => $set, 'secret' => $secret, 'image' => $image]);
    $html = $response->html();
    $_instance->logRenderedChild('7FAvKoC', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('xgtqmyt')) {
    $componentId = $_instance->getRenderedChildComponentId('xgtqmyt');
    $componentTag = $_instance->getRenderedChildComponentTagName('xgtqmyt');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('xgtqmyt');
} else {
    $response = \Livewire\Livewire::mount('settings.kin', ['user' => $user, 'type' => 'profile']);
    $html = $response->html();
    $_instance->logRenderedChild('xgtqmyt', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
} elseif ($_instance->childHasBeenRendered('RNeaY1M')) {
    $componentId = $_instance->getRenderedChildComponentId('RNeaY1M');
    $componentTag = $_instance->getRenderedChildComponentTagName('RNeaY1M');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('RNeaY1M');
} else {
    $response = \Livewire\Livewire::mount('settings.avatar', ['user' => $user]);
    $html = $response->html();
    $_instance->logRenderedChild('RNeaY1M', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
} elseif ($_instance->childHasBeenRendered('tSj1iwW')) {
    $componentId = $_instance->getRenderedChildComponentId('tSj1iwW');
    $componentTag = $_instance->getRenderedChildComponentTagName('tSj1iwW');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('tSj1iwW');
} else {
    $response = \Livewire\Livewire::mount('settings.kin', ['user' => $user, 'type' => 'kin']);
    $html = $response->html();
    $_instance->logRenderedChild('tSj1iwW', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
} elseif ($_instance->childHasBeenRendered('5SOQkFq')) {
    $componentId = $_instance->getRenderedChildComponentId('5SOQkFq');
    $componentTag = $_instance->getRenderedChildComponentTagName('5SOQkFq');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('5SOQkFq');
} else {
    $response = \Livewire\Livewire::mount('settings.notifications', ['user' => $user]);
    $html = $response->html();
    $_instance->logRenderedChild('5SOQkFq', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
} elseif ($_instance->childHasBeenRendered('T7BZCPL')) {
    $componentId = $_instance->getRenderedChildComponentId('T7BZCPL');
    $componentTag = $_instance->getRenderedChildComponentTagName('T7BZCPL');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('T7BZCPL');
} else {
    $response = \Livewire\Livewire::mount('bank.index', ['user' => $user, 'settings' => $set]);
    $html = $response->html();
    $_instance->logRenderedChild('T7BZCPL', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
} elseif ($_instance->childHasBeenRendered('6YzvQxJ')) {
    $componentId = $_instance->getRenderedChildComponentId('6YzvQxJ');
    $componentTag = $_instance->getRenderedChildComponentTagName('6YzvQxJ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('6YzvQxJ');
} else {
    $response = \Livewire\Livewire::mount('beneficiary.index', ['user' => $user]);
    $html = $response->html();
    $_instance->logRenderedChild('6YzvQxJ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
<?php echo $__env->make('user.menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\adv-banking\resources\views/user/profile/index.blade.php ENDPATH**/ ?>